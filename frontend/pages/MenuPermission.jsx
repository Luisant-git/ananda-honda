              ...
              <div>
                ...
                {editData.master && typeof editData.master === 'object' && (
                  <div className="ml-4 sm:ml-6 space-y-3">
                    {['customer_details', 'payment_mode', 'type_of_payment', 'type_of_collection', 'vehicle_model', 'service_payment_mode', 'service_type_of_payment',  'service_type_of_collection', 'create_enquiry'].map(module => (
                      <div key={module}>
