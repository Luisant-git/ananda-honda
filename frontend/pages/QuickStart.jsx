  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { view: 'service_payment_collection_xyz', label: 'Service Plan Payment (Service)', desc: 'Record service plan payments for RSA, AMC, EW.', icon: <CreditCard className="w-8 h-8 text-sky-600" />, perm: 'payment_collection.service.service_plan_payment_menu', bgColor: 'bg-sky-50 hover:bg-sky-100 border-sky-200' },
      ]
    },
    {
      title: "Reports",
      ...
      items: [
        ...
        { view: 'service_reports', label: 'Service Plan Payment report', desc: 'View service plan payment reports filtered by RSA, AMC, and EW.', icon: <FileBarChart className="w-8 h-8 text-sky-600" />, perm: 'reports.service_reports', bgColor: 'bg-sky-50 hover:bg-sky-100 border-sky-200' },
