  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-brand-surface p-4 sm:p-6 rounded-lg shadow-sm border border-brand-border">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
          <SearchableDropdown
            ...
            onChange={(value) =>
              setFilters({ ...filters, selectedCustomer: value })
            }
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium text-brand-text-secondary mb-1">
              From:
            </label>
            <input
              type="date"
          ...
          <div className="flex gap-2">
            <button
              ...
              className="w-full bg-brand-accent hover:bg-brand-accent-hover text-white font-bold py-2 px-4 rounded-lg"
            >
              Load
            </button>
            <button
      ...
      <Modal
        ...
        title={isEditMode ? "Edit Customer" : "Customer Entry"}
      >
      ...
      <Modal
        ...
        title="Vehicle Enquiry Management"
      >
        <div className="max-h-96 overflow-y-auto">
          <div className="mb-4">
            <h4 className="font-medium">
              Customer: {selectedCustomer?.name} - {selectedCustomer?.contactNo}
            </h4>
          </div>
            ...
            <div className="space-y-4">
              <div className="text-center">
                <h4 className="text-lg font-medium mb-2">
                  Welcome to Ananda Honda
                </h4>
                <p className="text-sm text-gray-600 mb-4">
                  Good morning/afternoon, sir/madam. How may I help you today?
                </p>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {enquiryTypes.map((type) => (
                      <button
                        key={type}
                        type="button"
                        onClick={() => handleEnquiryTypeSelect(type)}
            ...
            <form onSubmit={handleEnquirySubmit} className="space-y-4">
              <div className="text-center mb-4">
                <h5 className="font-medium">
                  Selected: {enquiryFormData.enquiryType.replace("_", " ")}
                </h5>
              </div>
              ...
              <div>
                ...
                <SearchableDropdown
                  options={(enquiryFormData.enquiryType === "BIG_WING"
                    ? bigWingModels
                    : accessoriesModels
                  ).map((model) => ({ value: model, label: model }))}
                  value={enquiryFormData.vehicleModelId}
                  onChange={(value) =>
                    setEnquiryFormData({
                      ...enquiryFormData,
              ...
              <div>
                ...
                <input
                  type="tel"
                  value={enquiryFormData.mobileNumber}
                  onChange={(e) => {
                    const numericValue = e.target.value.replace(/\D/g, "");
                ...
                <div className="grid grid-cols-2 gap-2">
                  {leadSources.map((source) => (
                    <label key={source} className="flex items-center text-sm">
                      <input
                        type="checkbox"
                        checked={enquiryFormData.leadSources.includes(source)}
              ...
              <div>
                ...
                <SearchableDropdown
                  options={(enquiryFormData.enquiryType === "BIG_WING"
                    ? bigWingExecutives
                    : accessoriesExecutives
                  ).map((name) => ({ value: name, label: name }))}
                  value={enquiryFormData.executiveName}
                  onChange={(value) =>
                    setEnquiryFormData({
                      ...enquiryFormData,
                      executiveName: value,
          ...
          {customerEnquiries.length > 0 && (
            <div className="mt-6 border-t pt-4">
              <h4 className="text-md font-medium mb-2">Customer Enquiries</h4>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {customerEnquiries.map((enquiry) => (
                      <tr key={enquiry.id}>
                        ...
                        <td className="px-4 py-2 text-sm">
                          {enquiry.executiveName || "Not Assigned"}
                        </td>
                        <td className="px-4 py-2 text-sm">
