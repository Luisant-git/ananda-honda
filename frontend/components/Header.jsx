        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative user-dropdown">
            <button 
              ...
              className="flex items-center space-x-2 text-brand-text-secondary hover:text-brand-text-primary">
              <UserIcon />
              <span className="font-medium">{user?.username || 'User'}</span>
            </button>
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-brand-surface border border-brand-border rounded-md shadow-lg z-50">
